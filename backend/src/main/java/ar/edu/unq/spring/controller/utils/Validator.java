...
public class Validator {
    ...
    private static final String DNI_CANT_CARACTERES_MIN = "El DNI debe tener un mínimo de 8 caracteres.";
    ...
    public void validarCreatePacienteDTO(CreatePacienteDTO createPacienteDTO) {
        ...
        if (createPacienteDTO.dni().length() < 8) {
            throw new IllegalArgumentException(DNI_CANT_CARACTERES_MIN);
        }
